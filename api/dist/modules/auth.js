...
module.exports.serviceManLogin = function (ttlMs) {
    ...
    return login(process.env.SERVICE_MAN_USERNAME, process.env.SERVICE_MAN_PASSWORD, ttlMs);
};
var loginToConfigServer = (module.exports.loginToApi = module.exports.loginToConfigServer = function (configServerUrl, username, password) {
    return Q.Promise(function (resolve, reject) {
        needle.post(configServerUrl, {
            username: username,
            password: password
...
module.exports.loginToLicenseServer = function (CONFIG_SERVER_LOGIN_URL) {
    ...
    return Q.Promise(function (resolve, reject) {
        utility
            ...
            loginToConfigServer(CONFIG_SERVER_LOGIN_URL, systemUuid, process.env.PASSWORD_PREFIX + utility.md5(systemUuid))
...
var logout = (module.exports.logout = function (accessToken) {
    return Q.Promise(function (resolve, reject) {
        ...
        needle.post(LOGOUT_REST_API.replace('{0}', accessToken), function (error, response) {
            if (error) {
