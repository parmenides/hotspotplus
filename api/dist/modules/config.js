...
var DEFAULT_ACCOUNTING_UPDATE_INTERVAL_SECONDS = process.env.DEFAULT_ACCOUNTING_UPDATE_INTERVAL_SECONDS || 60;
var FAST_ACCOUNTING_UPDATE_INTERVAL_SECONDS = process.env.FAST_ACCOUNTING_UPDATE_INTERVAL_SECONDS || 60;
...
module.exports = {
    ...
    AGGREGATE: {
        ...
        YEAR_MILLISECONDS: 6 * 31 * 24 * 60 * 60 * 1000 +
            5 * 30 * 24 * 60 * 60 * 1000 +
            29 * 24 * 60 * 60 * 1000,
    ...
    MIN_WALKBY_TIME_DEFAULT: 3,
    MAX_WALKBY_TIME_DEFAULT: 6,
    MIN_VISIT_TIME_DEFAULT: 10,
    MAX_VISIT_TIME_DEFAULT: 60,
    TIME_ZONE_DEFAULT: {
    ...
    BUSINESS_PAYMENT_RETURN_URL: function () {
        return (process.env.CALCULATED_EXTERNAL_API_ADDRESS +
    ...
    BUY_LOCAL_SMS_CHARGE_RETURN: function () {
        return (process.env.CALCULATED_WEB_APP_ADDRESS +
            mainPath +
    ...
    HOTSPOT_PAYMENT_RETURN_URL: function () {
        return (process.env.CALCULATED_HOTSPOT_ADDRESS +
