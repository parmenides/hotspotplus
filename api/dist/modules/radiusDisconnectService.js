            ...
            Business.findById(businessId)
                ...
                try {
                    ...
                    if (nasIp && port) {
                        ...
                        server.on('message', function (msg, rinfo) {
                            ...
                            if (packet.code === 'Disconnect-ACK') {
                                ...
                                server.close(function () {
                                    ...
                                    return reject(new Error('failed to disconnect user', username));
                                });
                            }
                        });
                        ...
                        server.send(podRequest, 0, podRequest.length, routerPort, routerAddress, function (error, bytes) {
                            if (error) {
                        ...
                        log.error('nas ip or port is empty, nothing to do, IP: ', nasIp, ', Port:', port);
                        return resolve();
                    }
                }
                catch (error) {
...
//# sourceMappingURL=radiusDisconnectService.js.map