...
module.exports = {
	...
	'mikrotik':        {
		...
		'mschapv2_challenge':       'MS-CHAP-Challenge',
		'mschapv2_password':        'MS-CHAP2-Response',
		'getRateLimit':             function ( rxRate, rxBurstRate, txRate, txBurstRate, burstTime ) {
			...
			if ( rxBurstRate > 12000000 || txBurstRate > 12000000 ) {
				...
				return rxRate + 'k/' + txRate + 'k ' +
					rxBurstRate + 'k/' + txBurstRate + 'k ' +
					Math.ceil ( rxBurstRate / 2 ) + 'k/' + Math.ceil ( txBurstRate / 2 ) + 'k ' +
					burstTime + '/' + burstTime
			}
		}
	}
