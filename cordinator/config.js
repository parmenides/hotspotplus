...
var CONFIG_SERVER_URL = "http://127.0.0.1:4000/api";

module.exports = {
	CONFIG_SERVER_URL:  CONFIG_SERVER_URL,
	LICENSE_LOGIN:      CONFIG_SERVER_URL + '/Licenses/login',
	CONFIG_SERVER_PING: CONFIG_SERVER_URL + '/LicenseAudits/ping?access_token={token}',
	DOWNLOAD_LICENSE:   CONFIG_SERVER_URL + '/Licenses/downloadLicense?systemUuid={systemUuid}&access_token={token}',
