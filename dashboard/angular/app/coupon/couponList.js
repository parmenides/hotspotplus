  ...
  function(
    ...
    $scope.addOrEditCoupon = function(row) {
      if (row) {
        ...
        Coupon.findById({ id: couponId }).$promise.then(
          function(res) {
          ...
          function($scope, $uibModalInstance) {
            ...
            $scope.save = function(error) {
              ...
              if (!error && !validationError) {
                if (!$scope.coupon.id) {
                  Coupon.create($scope.coupon).$promise.then(
                    function(res) {
    ...
    var getPage = function() {
      ...
      Coupon.count({ where: { ownerId: $scope.ownerId } }).$promise.then(
        function(result) {
