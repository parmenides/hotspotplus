 ...
 */
app.directive('customizeService', [
  'PREFIX',
  '$log',
  'uibButtonConfig',
  'Business',
  ...
  function(PREFIX, $log, uibButtonConfig, Business, $uibModal, Session) {
    ...
    return {
      ...
      controller: function($scope) {
        Business.loadServiceInfo().$promise.then(
          function(serviceInfo) {
            ...
            function calculateOnlineUsersCost() {
              ...
              for (var i = 0; i < onlineUsersPrice.length; i++) {
                ...
                if (
                  onlineUsers > priceRange.from &&
                  onlineUsers <= priceRange.to
                ) {
                  onlineUsersCost =
                    (onlineUsers - priceRange.from) * priceRange.price +
                    onlineUsersCost;
