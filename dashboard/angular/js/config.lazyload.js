...
angular
  ...
  .constant('JQ_CONFIG', {
    ...
    filestyle: [
      '../libs/jquery/bootstrap-filestyle/src/bootstrap-filestyle.js'
    ],
    slider: [
      '../libs/jquery/bootstrap-slider/bootstrap-slider.js',
    ...
    TouchSpin: [
      '../libs/jquery/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.js',
      '../libs/jquery/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.css'
    ],
    wysiwyg: [
      '../libs/jquery/bootstrap-wysiwyg/bootstrap-wysiwyg.js',
    ...
    footable: [
      '../libs/jquery/footable/v3/js/footable.min.js',
  ...
  .constant('MODULE_CONFIG', [
    ...
    },
    {
      ...
      files: [
        '../libs/angular/angular-wizard/angular-wizard.js',
        '../libs/angular/angular-wizard/angular-wizard.css',
        Window.PREFIX + 'css/customWizard.css'
      ]
    },
    {
      name: 'ui.bootstrap.persian.datepicker',
      files: [
        '../libs/assets/persian-date/persian-datepicker-tpls.js',
        '../libs/assets/persian-date/persiandate.js'
      ]
    },
    {
      name: 'chart.js',
