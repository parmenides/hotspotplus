		...
		files: [
			...
			},
			{
				src:    [
                    ...
                    'persian-date/persian-datepicker-tpls.js',
                    'persian-date/persiandate.js'
				],
				dest:   'libs/assets',
				cwd:    'bower_components',
				expand: true
			...
			{ src: '**', cwd: 'libs/assets/font-awesome/fonts', dest: 'src/fonts', expand: true },
			{ src: '**', cwd: 'libs/assets/simple-line-icons/fonts', dest: 'src/fonts', expand: true }
		]
	},
	angular: {
		files: [
			{ expand: true, src: [ '**', '!**/less/**' ], cwd: 'src/', dest: "angular/" },
			{ expand: true, src: [ '**' ], cwd: 'libs', dest: "angular/libs" },
			{ src: [ './favicon.ico' ], dest: "angular/" }
		]
	},
	html:    {
		files: [
