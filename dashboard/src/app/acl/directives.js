 ...
 */
app.directive ( 'checkAction', [ '$log', 'AclService', 'translateFilter', function ( $log, AclService, translateFilter ) {
	return {
		restrict: 'A',
			...
			var makeVisible = function () {
				...
				makeHidden = function ( message ) {
					...
					$ ( element ).popover ( {
						...
						html:      true,
						toggle:    'popover',
						title:     "<div style='color: #23b7e5;min-width: 250px'><i class='fa fa-fw fa-lock'></i>" + buyPremiumTitle + "</div>",
