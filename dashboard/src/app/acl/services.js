 ...
 */
app.service ( 'AclService', [ '$uibModal', '$log', '$q', '$location', 'PREFIX', 'Business', 'Session', 'translateFilter', function ( $uibModal, $log, $q, $location, PREFIX, Business, Session, translateFilter ) {
	...
	this.checkIfPermitted = function ( action, clbk, option ) {
		...
		var buyMemberPanelModule = translateFilter ( "general.buyMemberPanelModule" );
		var buyPaymentModule = translateFilter ( "general.buyPaymentModule" );
		 ...
		 if ( !businessPlanId || businessPlanId === 'premium' || businessPlanId === 'silver' || businessPlanId === 'gold' || businessPlanId === 'bronze' || businessPlanId === 'free' ) {
