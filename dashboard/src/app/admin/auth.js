...
app.controller( 'AdminSignInController', [ '$scope', '$log', 'User', '$state', 'appMessenger', 'Session', 'LoopBackAuth', 'roleService', 'errorMessenger',
	function ( $scope, $log, User, $state, appMessenger, Session, LoopBackAuth, roleService, errorMessenger ) {
		$scope.credential = {}
