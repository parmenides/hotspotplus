...
app.controller ( 'BusinessSignUpController', [ '$scope', '$log', 'Business', '$state', 'appMessenger', 'englishNumberFilter',
	function ( $scope, $log, Business, $state, appMessenger, englishNumberFilter ) {
		...
		$scope.signUp = function () {
			...
			Business.create ( $scope.business ).$promise.then ( function ( result ) {
...
app.controller ( 'BusinessSignInController', [ '$scope', '$log', 'Business', '$state', 'appMessenger', 'Session', 'LoopBackAuth', 'roleService', 'errorMessenger',
	function ( $scope, $log, Business, $state, appMessenger, Session, LoopBackAuth, roleService, errorMessenger ) {
		$scope.credential = {}
		$scope.authError = null
		$scope.signIn = function () {
			Business.login ( $scope.credential ).$promise.then ( function ( result ) {
				var SessionData = {}
		...
		$scope.signOut = function () {
			Business.logout ().$promise.then ( function () {
				$state.go ( 'access.signIn' )
