...
app.controller ( 'LcSignUpController', [ '$scope', '$log', 'Business', '$state', 'appMessenger', 'englishNumberFilter','$timeout',
	function ( $scope, $log, Business, $state, appMessenger, englishNumberFilter,$timeout ) {
		$scope.lc = {};
		...
		$scope.signUp = function () {
			...
			$scope.loading = true;
			Business.registerNewLicense ( $scope.lc ).$promise.then ( function ( result ) {
