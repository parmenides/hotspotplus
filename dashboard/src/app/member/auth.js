...
app.controller ( 'MemberSignInController', ['$scope', '$log', 'Member', 'Business', '$state', '$location', 'appMessenger', 'Session', 'LoopBackAuth', 'roleService', 'errorMessenger',
	function ( $scope, $log, Member, Business, $state, $location, appMessenger, Session, LoopBackAuth, roleService, errorMessenger ) {
		$scope.credential = {};
		...
		$scope.signIn = function () {
			...
			if ( businessId && businessId != '' ) {
				...
				Member.getBusinessId ( options ).$promise.then ( function ( username ) {
		...
		var login = function ( loginData ) {
			Member.login ( loginData ).$promise.then ( function () {
		...
		$scope.signOut = function () {
			Member.logout ().$promise.then ( function () {
