 ...
 */
app.directive( 'visitorGrowth', [ 'PREFIX', 'FootTraffic', '$log',
		...
		return {
			...
			controller:  function ( $scope ) {
				...
				function growthWidget () {
					...
					$scope.loading = true
					FootTraffic.getVisitorsPercent( visitorGrowth )
						...
						$log.error( 'can not get visitors count and growth rate from data source: ', error )
					} )
				};
			},
