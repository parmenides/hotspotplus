		...
		function ( $stateProvider, $urlRouterProvider, JQ_CONFIG, MODULE_CONFIG ) {
			...
			$stateProvider
				...
				.state ( 'app.networkAdminDashboard', {
					...
					templateUrl: TEMPLATE_PREFIX + 'app/business/tpl/app_dashboard_networkAdmin.html',
					resolve:     load ( [ 'moment', 'chart.js', 'ui.bootstrap.persian.datepicker',
				...
				.state ( 'app.purchaseSubscription', {
					...
					templateUrl: TEMPLATE_PREFIX + 'app/subscription/tpl/subscriptionPackages.html',
					resolve:     load ( [
						PREFIX + 'app/subscription/purchaseSubscription.js'
					] )
				} )
				.state ( 'app.loadDashboard', {
					url:        '/loading',
					controller: 'loadDashboardController',
					template:   '<div class="row wrapper-lg text-center" style="margin-top: 200px"><i class="fa fa-circle-o-notch fa-spin fa-5x"></i></div>',
				...
				.state ( 'app.coupons', {
					...
					resolve:     load ( [ 'ui.grid', 'ui.grid.pagination', 'ui.grid.selection', 'ui.bootstrap.persian.datepicker',
						PREFIX + 'app/coupon/couponList.js' ] )
				} )
				.state ( 'app.tickets', {
					url:         '/tickets',
					templateUrl: TEMPLATE_PREFIX + 'app/ticket/tpl/ticketList.html',
					resolve:     load ( [ 'ui.grid', 'ui.grid.pagination', 'ui.grid.selection',
				...
				.state ( 'app.campaigns', {
					...
					resolve:     load ( [ 'ui.grid', 'ui.grid.pagination', 'ui.grid.selection', 'moment', 'ui.bootstrap.persian.datepicker', 'mgo-angular-wizard', 'ui.grid.resizeColumns',
				...
				.state ( 'app.resellerBusinessList', {
					url:         '/businessList',
					templateUrl: TEMPLATE_PREFIX + 'app/reseller/tpl/resellerBusinessList.html',
					resolve:     load ( [ 'ui.grid', 'ui.grid.pagination', 'ui.grid.selection', 'ui.bootstrap.persian.datepicker', 'ui.grid.resizeColumns',
				...
				.state ( 'app.businessSettings', {
					...
					resolve:     load ( [ 'moment', 'ui.bootstrap.persian.datepicker', 'angularFileUpload',
				...
				.state ( 'app.customers', {
					...
					resolve:     load ( [ 'ui.grid', 'ui.grid.pagination', 'ui.grid.selection', 'ui.grid.resizeColumns',
				...
				.state ( 'app.internetPlans', {
					url:         '/internetPlans',
					templateUrl: TEMPLATE_PREFIX + 'app/internetPlan/tpl/internetPlanList.html',
					resolve:     load ( [ 'ui.grid', 'ui.grid.pagination', 'ui.grid.selection', 'ui.grid.resizeColumns',
				...
				.state ( 'app.members', {
					...
					resolve:     load ( [ 'ui.grid', 'ui.grid.pagination', 'ui.grid.selection', 'ui.grid.resizeColumns', 'ui.bootstrap.persian.datepicker',
						PREFIX + 'app/member/memberList.js', PREFIX + 'app/member/planHistoryList.js' ] )
				} )
				.state ( 'access.signUp', {
					url:         '/signup',
				...
				.state ( 'access.publicCustomizeService', {
					...
					templateUrl: TEMPLATE_PREFIX + 'app/business/tpl/publicCustomizeService.html',
					resolve:     load ( [
				...
				.state ( 'app.memberDashboard', {
					url:         '/memberDashboard',
					templateUrl: TEMPLATE_PREFIX + 'app/member/tpl/app_dashboard_member.html',
					resolve:     load ( [ 'moment', 'chart.js', 'ui.bootstrap.persian.datepicker',
