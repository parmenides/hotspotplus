...
/* Controllers */
angular.module ( 'app' )
	.controller ( 'AppCtrl', [ '$scope', '$translate', '$localStorage', '$window', '$rootScope', 'Session', '$state',
		function ( $scope, $translate, $localStorage, $window, $rootScope, Session, $state ) {
			...
			$scope.langs = { en: 'English', de_DE: 'German', it_IT: 'Italian', fa_IR: 'Persian' };
			$scope.selectLang = $scope.langs[ $translate.proposedLanguage () ] || "Persian";
