angular.module ( 'masterHotspotApp' ).service ( 'appMessenger', [ 'toaster', 'translateFilter', function ( toaster, translateFilter ) {
	...
	.service ( 'loadingModal', [ '$log', '$uibModal',
	...
	.service ( 'numberService', [ '$log', function ( $log ) {
	...
	.service ( 'nationalCode', [ '$log', 'englishNumberFilter', function ( $log, englishNumberFilter ) {
		this.isValid = function ( code ) {
			...
			if ( 7 < length && length < 11 ) {
				...
				if ( (validationRes < 2 && validationRes == validationCode) || (11 - validationRes == validationCode) ) {
					return true;
				} else {
					return false;
				}
	...
	.service ( 'birthday', [ '$log', 'englishNumberFilter', function ( $log, englishNumberFilter ) {
