angular.module("hotspotplus.tpls.alpha", ["alphaForgetPassword.tpl.html", "alphaInternetPlan.tpl.html", "alphaLang.tpl.html", "alphaLayout.tpl.html", "alphaSignIn.tpl.html", "alphaSignUp.tpl.html", "alphaStatus.tpl.html", "alphaVerify.tpl.html"]);

angular.module("alphaForgetPassword.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("alphaForgetPassword.tpl.html",
...
angular.module("alphaInternetPlan.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("alphaInternetPlan.tpl.html",
...
angular.module("alphaLang.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("alphaLang.tpl.html",
...
angular.module("alphaLayout.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("alphaLayout.tpl.html",
...
angular.module("alphaSignIn.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("alphaSignIn.tpl.html",
    "<section desc=\"SignIn\">\n" +
    "    <div class=\"row\">\n" +
...
angular.module("alphaSignUp.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("alphaSignUp.tpl.html",
    "<section desc=\"SignUp\">\n" +
    "    <div class=\"row\">\n" +
...
angular.module("alphaStatus.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("alphaStatus.tpl.html",
    "<section desc=\"Status\">\n" +
    "  <div class=\"row\">\n" +
    "    <form class=\"col-md-6 col-md-offset-3 col-sm-12\">\n" +
    "      <div class=\"row\">\n" +
...
angular.module("alphaVerify.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("alphaVerify.tpl.html",
