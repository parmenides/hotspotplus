...
angular.module("template/persianDatepicker/popup.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/persianDatepicker/popup.html",
    ...
    "<ul style=\"direction:ltr;\" class=\"dropdown-menu\" ng-style=\"{display: (isOpen && 'block') || 'none', top: position.top+'px'}\" ng-keydown=\"keydown($event)\">\n" +
    "	<li ng-transclude></li>\n" +
    "	<li ng-if=\"showButtonBar\" style=\"padding:10px 9px 2px\">\n" +
    "		<span class=\"btn-group\">\n" +
    "			<button type=\"button\" class=\"btn btn-sm btn-primary\" ng-click=\"select('today')\">{{ \"date.today\" | translate }}</button>\n" +
    "			<button type=\"button\" class=\"btn btn-sm btn-default\" ng-click=\"select(null)\">{{  \"date.clear\" | translate }}</button>\n" +
    "		</span>\n" +
    "		<button type=\"button\" class=\"btn btn-sm btn-warning pull-right\" ng-click=\"close()\">{{  \"date.close\" | translate  }}</button>\n" +
    "	</li>\n" +
    "</ul>\n" +
    "");
}]);
