  ...
  try {
    ...
    getIpSession(hostIp)
      .then(function(nasSession) {
        ...
        getMemberSession(bizId, nasId, clientIp)
          .then(function(memberSession) {
            const sysLog = {
              ...
              logDateStr: new Date(syslogData['@timestamp']).toLocaleString(
                'fa-IR',
                { timeZone: 'Asia/Tehran' },
              ),
              creationDate: new Date().getTime(),
              creationDateStr: new Date().toLocaleString('fa-IR', {
                timeZone: 'Asia/Tehran',
              }),
              businessId: bizId,
              nasId: nasId,
